...
- [ ] Explain what a token is used for.
 [Answer] A token is used for authentication.

- [ ] What steps can you take in your web apps to keep your data secure?
[Answer] You can use authentication to make sure only certain users have access to sensitive data.

- [ ] Describe how web servers work.
[Answer] A browser requests information from a web server and the server responds with that information, allowing it to be viewed.
